...
def main() -> int:
    ...
    if event == "UserPromptSubmit":
        messages = [
            ...
            " For resource-sensitive multi-stage work, call research_design resource_plan_action=inventory and then plan a main-agent-selected serial DAG; simple one-response work is exempt. Do not infer network access, estimates, or a whole-task deadline. Record stage artifacts, and inspect a receipt before resolving or replaying UNKNOWN completion."
