---
name: research-guard
description: Evidence-bounded cross-disciplinary academic research with resource-aware task planning, field initialization, idea exploration, novelty checks, cited writing, executable Lean/Pint/SymPy/Z3/numerical formula verification, OpenReview calibration, scientific-image integrity, experiments, reproducibility, figures, and manuscript audit. Use for research ideas, literature, citations, method changes, resource-constrained workflows, humanities or STEM research, paper writing/auditing, equations, experiments, reviews, or academic images.
---
