...
8. AI-reviewer robustness is an adversarial integrity audit, not a score optimizer. Reject hidden reviewer instructions, prompt injection, score-targeted paraphrase selection, prestige signaling, and deletion of valid limitations, ethics, risks, criticism, or negative results.
